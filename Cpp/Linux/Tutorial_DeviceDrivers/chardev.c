...
static ssize_t device_read(struct file *file, /* see include/linux/fs.h */
		...
		loff_t * offseti /* Number of bytes actually written to the buffer*/)
{
		int bytes_read = 0;
...
/* Module Declarations */
/*
 * New version for file_operations -> it uses unlocked_ioctl, instead of ioctl.
 * based on https://lwn.net/Articles/119652/
 * ------------
...
//		.ioctl = device_ioctl, .open = device_open, .release = device_release,
/* a.k.a. close */
//};
struct file_operations Fops = { .read = device_read, .write = device_write,
		.unlocked_ioctl = device_ioctl, .open = device_open, .release = device_release,
/* a.k.a. close */
};
